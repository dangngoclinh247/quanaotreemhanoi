    ...
    <div id="products-tag-wrapper" class="col-md-5 no-padding-left">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="form-add-ptag" action="/admin.php?c=products_tag&m=index" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ptag_content" name="ptag_content"></textarea>
                    </div>
                    <div class="form-group">
                ...
                <textarea class="form-control" id="ptag_seo_description" name="ptag_seo_description"
                    ...
                    <div id="btn-group" class="form-group">
                        <button id="btn-ptag-add" name="btn_ptag_add" type="submit" class="btn btn-success">Thêm Tag
                        </button>
