    ...
    <div id="ntype-wrapper" class="col-md-5 no-padding-left padding-right">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body no-padding">
                <form id="form-ntype-add" action="" method="post">
                    ...
                    <div id="btn-group" class="form-group">
                        <button id="btn-add-ntype" name="btn_ntype_add" type="submit" class="btn btn-success">Thêm
                            Category
                        </button>
