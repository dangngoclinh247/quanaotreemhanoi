            ...
            <div class="panel-body">
                ...
                <table id="table-products-list" class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th style="width: 58%;">Tên sản phẩm</th>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a class="btn btn-sm btn-success"
                                   href="/admin.php?c=products&m=products_edit&p=<?php echo $product['pro_id']; ?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a class="btn btn-sm btn-danger" href="#"
                                   onclick="del(<?php echo $product['pro_id']; ?>, this);"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                        <?php
                    }
