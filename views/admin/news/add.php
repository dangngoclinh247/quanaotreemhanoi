...
?>
    <form id="form-news-add" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div id="news_add_right" class="col-md-3 no-padding">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" class="status" value="1">Xuất bản
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" class="status" value="2" checked>Bản nháp
                        </label>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="datetimepicker">
                            <input type="text" class="form-control" id="news_publish_date" name="news_publish_date"
                                   disabled>
                            <span class="input-group-addon"><i class="fa fa-calendar fa-fw"></i></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" id="btn-save" name="btn_save" class="btn btn-success">Lưu</button>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
