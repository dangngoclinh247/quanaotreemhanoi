    ...
    <div class="page-wrapper white-section clearfix">
        ...
        <div id="single-shop" class="row">
            ...
            if (isset($_SESSION['cart'])) {
                            ...
                            foreach ($products as $cart) {
                                ...
                                <tr data-id="<?php echo $product['pro_id']; ?>"
                                    ...
                                    <span class="cart-quantity center-block"
                                          data-id="<?php echo $product['pro_id']; ?>"
                                          data-quantity="<?php echo $quantity; ?>"
                                          data-size="<?php echo $product['pro_size']; ?>"><?php echo $quantity; ?></span>
                                    </td>
                                    <td>
                                    <span
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" name="user_name" id="user_name"
                                                           class="form-control"
                                                           placeholder="First Name"
                                                           value="<?php echo $this->user['user_name']; ?>">
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label>Email</label>
                                                    <input type="email" name="user_email" id="user_email"
                                                           class="form-control"
                                                           placeholder="Company Name"
                                                           value="<?php echo $this->user['user_email']; ?>" disabled>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label>Số điện thoại *</label>
                                                    <input type="text" name="user_phone1" id="user_phone1"
                                                           class="form-control"
                                                           placeholder="Address Line 1"
                                                           value="<?php echo $this->user['user_phone1']; ?>">
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label>Địa chỉ *</label>
                                            <textarea name="user_address" id="user_address" class="form-control"
                                                      placeholder="Địa chỉ"
                                                      rows="4"><?php echo $this->user['user_address']; ?></textarea>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <!-- end row -->
                ...
                ?>
                <div class="col-md-12">
                    <div class="notfound big-title text-center">
                        <h3>Thành Công</h3>

                        <p>Cảm ơn bạn đã tin tưởng và Order sản phẩm chúng tôi. Chúng tôi sẽ liên hệ với bạn trong vòng 24h.</p>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on("click", ".cart-quantity", function () {
                ...
                $(".quantity-update").focus();
                /*                $(".quantity-update").onkeyup(function(e) {
                 if(e.which == 13)
                 {
                 $(".quantity-update").trigger("blur");
                 }
                 })*/
            });
            ...
            $(document).on("blur", ".quantity-update", function () {
                ...
                var pro_id = tr.attr("data-id");
                var pro_price = tr.attr("data-price");
                var pro_size = tr.attr("data-size");
                var pro_price_total = (parseInt(pro_price) * parseInt(pro_size) * parseInt(quantity)).format(0, 3, ",");
                $.ajax({
